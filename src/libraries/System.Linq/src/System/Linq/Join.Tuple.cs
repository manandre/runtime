...
namespace System.Linq
{
    public static partial class Enumerable
    {
        ...
        /// <example>
        /// <para>
        /// The following code example demonstrates how to use <see cref="Join{TOuter, TInner, TKey}(IEnumerable{TOuter}, IEnumerable{TInner}, Func{TOuter, TKey}, Func{TInner, TKey})" /> to perform an inner join of two sequences based on a common key.
        /// </para>
        /// <code>
        /// class Person
        /// {
        ...
        /// <see cref="Join{TOuter, TInner, TKey}(IEnumerable{TOuter}, IEnumerable{TInner}, Func{TOuter, TKey}, Func{TInner, TKey})" />
        /// brings the two information sources and the keys by which they are matched together in one method call.
        /// </para>
        /// <para>
        /// In relational database terms, the <see cref="Join{TOuter, TInner, TKey}(IEnumerable{TOuter}, IEnumerable{TInner}, Func{TOuter, TKey}, Func{TInner, TKey})" /> method implements an inner equijoin.
        ...
        /// <see cref="LeftJoin{TOuter, TInner, TKey}(IEnumerable{TOuter}, IEnumerable{TInner}, Func{TOuter, TKey}, Func{TInner, TKey})" /> method,
        /// and a right outer join can be performed using the
        /// <see cref="RightJoin{TOuter, TInner, TKey}(IEnumerable{TOuter}, IEnumerable{TInner}, Func{TOuter, TKey}, Func{TInner, TKey})" /> method,
        ...
        public static IEnumerable<(TOuter Outer, TInner Inner)> Join<TOuter, TInner, TKey>(this IEnumerable<TOuter> outer, IEnumerable<TInner> inner, Func<TOuter, TKey> outerKeySelector, Func<TInner, TKey> innerKeySelector) =>
            Join(outer, inner, outerKeySelector, innerKeySelector, comparer: null);
        ...
        /// <example>
        /// <para>
        /// The following code example demonstrates how to use <see cref="Join{TOuter, TInner, TKey}(IEnumerable{TOuter}, IEnumerable{TInner}, Func{TOuter, TKey}, Func{TInner, TKey}, IEqualityComparer{TKey})" /> to perform an inner join of two sequences based on a common key.
        /// </para>
        /// <code>
        /// class Person
        /// {
        ...
        /// <para>
        /// A join refers to the operation of correlating the elements of two sources of information based on a common key.
        /// <see cref="Join{TOuter, TInner, TKey}(IEnumerable{TOuter}, IEnumerable{TInner}, Func{TOuter, TKey}, Func{TInner, TKey}, IEqualityComparer{TKey})" />
        /// brings the two information sources and the keys by which they are matched together in one method call.
        /// </para>
        /// <para>
        /// In relational database terms, the <see cref="Join{TOuter, TInner, TKey}(IEnumerable{TOuter}, IEnumerable{TInner}, Func{TOuter, TKey}, Func{TInner, TKey}, IEqualityComparer{TKey})" /> method implements an inner equijoin.
        /// 'Inner' means that only elements that have a match in the other sequence are included in the results.
        /// An 'equijoin' is a join in which the keys are compared for equality.
        /// An left outer join can be performed using the
        /// <see cref="LeftJoin{TOuter, TInner, TKey}(IEnumerable{TOuter}, IEnumerable{TInner}, Func{TOuter, TKey}, Func{TInner, TKey}, IEqualityComparer{TKey})" /> method,
        /// and a right outer join can be performed using the
        /// <see cref="RightJoin{TOuter, TInner, TKey}(IEnumerable{TOuter}, IEnumerable{TInner}, Func{TOuter, TKey}, Func{TInner, TKey}, IEqualityComparer{TKey})" /> method,
        /// For more information, see <see href="/dotnet/csharp/linq/standard-query-operators/join-operations">Join operations</see>.
        /// </para>
        /// </remarks>
        public static IEnumerable<(TOuter Outer, TInner Inner)> Join<TOuter, TInner, TKey>(this IEnumerable<TOuter> outer, IEnumerable<TInner> inner, Func<TOuter, TKey> outerKeySelector, Func<TInner, TKey> innerKeySelector, IEqualityComparer<TKey>? comparer)
        {
            ...
            return JoinIterator(outer, inner, outerKeySelector, innerKeySelector, comparer);
        }

        private static IEnumerable<(TOuter Outer, TInner Inner)> JoinIterator<TOuter, TInner, TKey>(IEnumerable<TOuter> outer, IEnumerable<TInner> inner, Func<TOuter, TKey> outerKeySelector, Func<TInner, TKey> innerKeySelector, IEqualityComparer<TKey>? comparer)
        {
