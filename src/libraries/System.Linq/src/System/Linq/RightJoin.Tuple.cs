...
namespace System.Linq
{
    public static partial class Enumerable
    {
        ...
        /// <example>
        /// <para>
        /// The following code example demonstrates how to use <see cref="RightJoin{TOuter, TInner, TKey}(IEnumerable{TOuter}, IEnumerable{TInner}, Func{TOuter, TKey}, Func{TInner, TKey})" /> to perform aa left outer join of two sequences based on a common key.
        /// </para>
        /// <code>
        /// class Person
        /// {
        ...
        /// <see cref="RightJoin{TOuter, TInner, TKey}(IEnumerable{TOuter}, IEnumerable{TInner}, Func{TOuter, TKey}, Func{TInner, TKey})" />
        /// brings the two information sources and the keys by which they are matched together in one method call.
        /// </para>
        /// <para>
        /// In relational database terms, the <see cref="RightJoin{TOuter, TInner, TKey}(IEnumerable{TOuter}, IEnumerable{TInner}, Func{TOuter, TKey}, Func{TInner, TKey})" /> method implements an outer right equijoin.
        ...
        /// <example>
        /// <para>
        /// The following code example demonstrates how to use <see cref="RightJoin{TOuter, TInner, TKey}(IEnumerable{TOuter}, IEnumerable{TInner}, Func{TOuter, TKey}, Func{TInner, TKey}, IEqualityComparer{TKey})" /> to perform aa left outer join of two sequences based on a common key.
        /// </para>
        /// <code>
        /// class Person
        /// {
        ...
        /// <para>
        /// A join refers to the operation of correlating the elements of two sources of information based on a common key.
        /// <see cref="RightJoin{TOuter, TInner, TKey}(IEnumerable{TOuter}, IEnumerable{TInner}, Func{TOuter, TKey}, Func{TInner, TKey}, IEqualityComparer{TKey})" />
        /// brings the two information sources and the keys by which they are matched together in one method call.
        /// </para>
        /// <para>
        /// In relational database terms, the <see cref="RightJoin{TOuter, TInner, TKey}(IEnumerable{TOuter}, IEnumerable{TInner}, Func{TOuter, TKey}, Func{TInner, TKey}, IEqualityComparer{TKey})" /> method implements an outer right equijoin.
        /// 'Outer right' means that elements of the second sequence are returned regardless of whether matching elements are found in the other sequence.
        /// An 'equijoin' is a join in which the keys are compared for equality.
        /// An inner join - where only elements that have a match in the other sequence are included in the results - can be performed using the
