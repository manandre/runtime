...
{
    public class LeftJoinTupleTests : EnumerableTests
    {
        ...
        public void OuterEmptyInnerNonEmpty()
        {
            ...
            Assert.Empty(outer.LeftJoin(inner, e => e.custID, e => e.custID));
        }
        ...
        public void FirstOuterMatchesLastInnerLastOuterMatchesFirstInnerSameNumberElements()
        {
            ...
            [
                ...
                (new CustomerRec{ name = "Tim", custID = 99021 }, null),
                (new CustomerRec{ name = "Robert", custID = 99022 }, new OrderRec{ orderID = 45321, custID = 99022, total = 50 })
            ];

            Assert.Equal(expected, outer.LeftJoin(inner, e => e.custID, e => e.custID));
        }
        ...
        public void NullComparer()
        {
            ...
            [
                ...
                (new CustomerRec{ name = "Tim", custID = 99021 }, null),
                (new CustomerRec{ name = "Robert", custID = 99022 }, null)
            ];

            Assert.Equal(expected, outer.LeftJoin(inner, e => e.name, e => e.name, null));
        }
        ...
        public void CustomComparer()
        {
            ...
            Assert.Equal(expected, outer.LeftJoin(inner, e => e.name, e => e.name, new AnagramEqualityComparer()));
        }
        ...
        public void OuterNull()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("outer", () => outer.LeftJoin(inner, e => e.name, e => e.name, new AnagramEqualityComparer()));
        }
        ...
        public void InnerNull()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("inner", () => outer.LeftJoin(inner, e => e.name, e => e.name, new AnagramEqualityComparer()));
        }
        ...
        public void OuterKeySelectorNull()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("outerKeySelector", () => outer.LeftJoin(inner, null, e => e.name, new AnagramEqualityComparer()));
        }
        ...
        public void InnerKeySelectorNull()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("innerKeySelector", () => outer.LeftJoin(inner, e => e.name, null, new AnagramEqualityComparer()));
        }
        ...
        public void OuterNullNoComparer()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("outer", () => outer.LeftJoin(inner, e => e.name, e => e.name));
        }
        ...
        public void InnerNullNoComparer()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("inner", () => outer.LeftJoin(inner, e => e.name, e => e.name));
        }
        ...
        public void OuterKeySelectorNullNoComparer()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("outerKeySelector", () => outer.LeftJoin(inner, null, e => e.name));
        }
        ...
        public void InnerKeySelectorNullNoComparer()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("innerKeySelector", () => outer.LeftJoin(inner, e => e.name, null));
        }
        ...
        public void NullElements()
        {
            ...
            Assert.Equal(expected, outer.LeftJoin(inner, e => e, e => e, EqualityComparer<string>.Default));
        }
        ...
        public void OuterNonEmptyInnerEmpty()
        {
            ...
            (CustomerRec, OrderRec?)[] expected =
            [
                (new CustomerRec{ name = "Tim", custID = 43434 }, null),
                (new CustomerRec{ name = "Bob", custID = 34093 }, null)
            ];
        ...
        public void SingleElementEachAndDoesntMatch()
        {
            ...
            (CustomerRec, OrderRec?)[] expected =
            [
                (new CustomerRec { name = "Prakash", custID = 98922 }, null)
            ];
        ...
        public void SelectorsReturnNull()
        {
            ...
            (int?, int?)[] expected = [(null, null), (null, null)];

            Assert.Equal(expected, outer.LeftJoin(inner, e => e, e => e));
        }
        ...
        public void NoMatches()
        {
            ...
            (CustomerRec, OrderRec?)[] expected =
            [
                (new CustomerRec{ name = "Prakash", custID = 98022 }, null),
                (new CustomerRec{ name = "Bob", custID = 99022 }, null),
                (new CustomerRec{ name = "Tim", custID = 99021 }, null),
                (new CustomerRec{ name = "Robert", custID = 99022 }, null)
            ];
        ...
        {
            var iterator = NumberRangeGuaranteedNotCollectionType(0, 3).LeftJoin(Enumerable.Empty<int>(), i => i, i => i);
