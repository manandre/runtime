...
namespace System.Linq.Tests
{
    public class RightJoinTests : EnumerableTests
    {
        ...
        public void NullComparer()
        {
            ...
            JoinRec[] actual = outer.RightJoin(inner, e => e.name, e => e.name, createJoinRec, null).ToArray();
        ...
        public void OuterNonEmptyInnerEmpty()
        {
            ...
            OrderRec[] inner = { };
            Assert.Empty(outer.RightJoin(inner, e => e.custID, e => e.custID, createJoinRec));
        }
        ...
        public void SingleElementEachAndDoesntMatch()
        {
            ...
            OrderRec[] inner = new [] { new OrderRec { orderID = 45321, custID = 98022, total = 50 } };
            JoinRec[] expected = new [] { new JoinRec { name = null, orderID = 45321, total = 50 } };
            Assert.Equal(expected, outer.RightJoin(inner, e => e.custID, e => e.custID, createJoinRec));
        }
