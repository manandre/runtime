...
{
    public class JoinTupleTests : EnumerableTests
    {
        ...
        public void OuterEmptyInnerNonEmpty()
        {
            ...
            Assert.Empty(outer.Join(inner, e => e.custID, e => e.custID));
        }
        ...
        public void FirstOuterMatchesLastInnerLastOuterMatchesFirstInnerSameNumberElements()
        {
            ...
            Assert.Equal(expected, outer.Join(inner, e => e.custID, e => e.custID));
        }
        ...
        public void NullComparer()
        {
            ...
            Assert.Equal(expected, outer.Join(inner, e => e.name, e => e.name, null));
        }
        ...
        public void CustomComparer()
        {
            ...
            Assert.Equal(expected, outer.Join(inner, e => e.name, e => e.name, new AnagramEqualityComparer()));
        }
        ...
        public void OuterNull()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("outer", () => outer.Join(inner, e => e.name, e => e.name, new AnagramEqualityComparer()));
        }
        ...
        public void InnerNull()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("inner", () => outer.Join(inner, e => e.name, e => e.name, new AnagramEqualityComparer()));
        }
        ...
        public void OuterKeySelectorNull()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("outerKeySelector", () => outer.Join(inner, null, e => e.name, new AnagramEqualityComparer()));
        }
        ...
        public void InnerKeySelectorNull()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("innerKeySelector", () => outer.Join(inner, e => e.name, null, new AnagramEqualityComparer()));
        }
        ...
        public void OuterNullNoComparer()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("outer", () => outer.Join(inner, e => e.name, e => e.name));
        }
        ...
        public void InnerNullNoComparer()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("inner", () => outer.Join(inner, e => e.name, e => e.name));
        }
        ...
        public void OuterKeySelectorNullNoComparer()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("outerKeySelector", () => outer.Join(inner, null, e => e.name));
        }
        ...
        public void InnerKeySelectorNullNoComparer()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("innerKeySelector", () => outer.Join(inner, e => e.name, null));
        }
        ...
        public void SkipsNullElements()
        {
            ...
            (string, string)[] expected = [(string.Empty, string.Empty)];

            Assert.Equal(expected, outer.Join(inner, e => e, e => e, EqualityComparer<string>.Default));
        }
        ...
        public void SelectorsReturnNull()
        {
            ...
            Assert.Empty(outer.Join(inner, e => e, e => e));
        }
        ...
        {
            var iterator = NumberRangeGuaranteedNotCollectionType(0, 3).Join(Enumerable.Empty<int>(), i => i, i => i);
