...
namespace System.Linq
{
    public static partial class AsyncEnumerable
    {
        ...
        /// <returns>An <see cref="IAsyncEnumerable{T}" /> that has elements of type <c>(<typeparamref name="TOuter"/>, <typeparamref name="TInner"/>)</c> that are obtained by performing a left outer join on two sequences.</returns>
            ...
            IEqualityComparer<TKey>? comparer = null)
        {
            ...
            return
                outer.IsKnownEmpty() ? Empty<(TOuter, TInner?)>() :
        ...
        /// <typeparam name="TInner">The type of the elements of the second sequence.</typeparam>
        /// <typeparam name="TKey">The type of the keys returned by the key selector functions.</typeparam>
        /// <returns>An <see cref="IEnumerable{T}" /> that has elements of type <c>(<typeparamref name="TOuter"/>, <typeparamref name="TInner"/>)</c> that are obtained by performing a left outer join on two sequences.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="outer" /> is <see langword="null" />.</exception>
        /// <exception cref="ArgumentNullException"><paramref name="inner" /> is <see langword="null" />.</exception>
        /// <exception cref="ArgumentNullException"><paramref name="outerKeySelector" /> is <see langword="null" />.</exception>
        /// <exception cref="ArgumentNullException"><paramref name="innerKeySelector" /> is <see langword="null" />.</exception>
