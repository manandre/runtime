...
namespace System.Linq
{
    public static partial class AsyncEnumerable
    {
        ...
        /// <returns>
        /// An <see cref="IAsyncEnumerable{T}"/> that has elements of type <c>(<typeparamref name="TOuter"/>, <typeparamref name="TInner"/>)</c>
            ...
            IEqualityComparer<TKey>? comparer = null)
        {
            ...
            return
                outer.IsKnownEmpty() || inner.IsKnownEmpty() ? Empty<(TOuter, TInner)>() :
