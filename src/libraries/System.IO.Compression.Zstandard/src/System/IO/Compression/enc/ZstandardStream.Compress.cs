...
namespace System.IO.Compression
{
    ...
    public sealed partial class ZstandardStream : Stream
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="System.IO.Compression.ZstandardStream" /> class by using the specified stream and compression level.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="System.IO.Compression.ZstandardStream" /> class by using the specified stream and compression level, and optionally leaves the stream open.</summary>
        /// <param name="stream">The stream to compress.</param>
        /// <param name="compressionLevel">One of the enumeration values that indicates whether to emphasize speed or compression efficiency when compressing the stream.</param>
        /// <param name="leaveOpen"><see langword="true" /> to leave the stream open after disposing the <see cref="System.IO.Compression.ZstandardStream" /> object; otherwise, <see langword="false" />.</param>
        ...
        {
            _encoder.SetCompressionLevel(ZstandardUtils.GetCompressionLevel(compressionLevel));
        }
        ...
        /// <exception cref="InvalidOperationException">Cannot perform write operations on a <see cref="ZstandardStream" /> constructed with <see cref="CompressionMode.Decompress" />.
        /// -or-
        ...
        /// <summary>Writes a sequence of bytes to the current Zstandard stream from a read-only byte span and advances the current position within this Zstandard stream by the number of bytes written.</summary>
        /// <param name="buffer">A region of memory. This method copies the contents of this region to the current Zstandard stream.</param>
        /// <remarks>Use the <see cref="System.IO.Compression.ZstandardStream.CanWrite" /> property to determine whether the current instance supports writing. Use the <see langword="System.IO.Compression.ZstandardStream.WriteAsync" /> method to write asynchronously to the current stream.
        /// If the write operation is successful, the position within the Zstandard stream advances by the number of bytes written. If an exception occurs, the position within the Zstandard stream remains unchanged.</remarks>
        ...
        internal void WriteCore(ReadOnlySpan<byte> buffer, bool isFinalBlock = false)
        {
            if (_mode != CompressionMode.Compress)
                throw new InvalidOperationException(SR.ZstandardStream_Decompress_UnsupportedOperation);
            EnsureNotDisposed();
        ...
        /// <exception cref="System.NotSupportedException">The current <see cref="System.IO.Compression.ZstandardStream" /> implementation does not support the write operation.</exception>
        ...
        /// <summary>Asynchronously writes compressed bytes to the underlying Zstandard stream from the specified byte array.</summary>
        /// <param name="buffer">The buffer that contains the data to compress.</param>
        /// <param name="offset">The zero-based byte offset in <paramref name="buffer" /> from which to begin copying bytes to the Zstandard stream.</param>
        /// <param name="count">The maximum number of bytes to write.</param>
        ...
        /// Use the <see cref="System.IO.Compression.ZstandardStream.CanWrite" /> property to determine whether the current instance supports writing.
        ...
        /// <summary>Asynchronously writes compressed bytes to the underlying Zstandard stream from the specified byte memory range.</summary>
        ...
        /// <summary>Asynchronously clears all buffers for this Zstandard stream, causes any buffered data to be written to the underlying device, and monitors cancellation requests.</summary>
        /// <param name="cancellationToken">The token to monitor for cancellation requests. The default value is <see cref="System.Threading.CancellationToken.None" />.</param>
