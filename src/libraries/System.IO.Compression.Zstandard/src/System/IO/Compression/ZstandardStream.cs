...
namespace System.IO.Compression
{
    ...
    public sealed partial class ZstandardStream : Stream
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="System.IO.Compression.ZstandardStream" /> class by using the specified stream and compression mode.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="System.IO.Compression.ZstandardStream" /> class by using the specified stream and compression mode, and optionally leaves the stream open.</summary>
        /// <param name="stream">The stream to compress.</param>
        /// <param name="mode">One of the enumeration values that indicates whether to compress or decompress the stream.</param>
        /// <param name="leaveOpen"><see langword="true" /> to leave the stream open after the <see cref="System.IO.Compression.ZstandardStream" /> object is disposed; otherwise, <see langword="false" />.</param>
        ...
        /// <summary>Releases the unmanaged resources used by the <see cref="System.IO.Compression.ZstandardStream" /> and optionally releases the managed resources.</summary>
        ...
        /// <summary>Asynchronously releases the unmanaged resources used by the <see cref="System.IO.Compression.ZstandardStream" />.</summary>
        ...
        /// This method disposes the Zstandard stream by writing any changes to the backing store and closing the stream to release resources.
        /// Calling `DisposeAsync` allows the resources used by the <see cref="System.IO.Compression.ZstandardStream" /> to be reallocated for other purposes. For more information, see [Cleaning Up Unmanaged Resources](/dotnet/standard/garbage-collection/unmanaged).</remarks>
